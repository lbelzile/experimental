...
.float-left.center[.box-6[`Boost`] .box-6[`Boost Plus`] .box-6[Consensus only (`consensus`)] ]
...
.box-6.medium[NO! ANCOVA is a design to reduce error]
...
.box-6.sp-after[Compare two nested models]

.box-inv-6.sp-after[

$\mathscr{H}_0$: Model with covariate

]

.box-inv-6.sp-after[
$\mathscr{H}_a$:
Model with covariate * experimental factor<br>(interaction)]
