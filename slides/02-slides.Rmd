...
The _p_-values and confidence intervals for pairwise differences between groups $j$ and $k$ are based on the _t_-statistic:
...
ggplot(data = confint_dat,
  ...
  geom_segment(mapping = aes(y = lower, 
                             ...
                             col = covers), 
               alpha = 0.5) +
  scale_color_discrete(type = c("skyblue1","tomato")) +
