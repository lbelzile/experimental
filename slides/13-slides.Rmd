...
kable(m0, caption = "expected counts") |>
  kableExtra::kable_styling(full_width = FALSE, position = "float_left")
kable(m1, caption = "observed counts") |>
...
The test statistic is $`r round(as.numeric(broom::tidy(chisq.test(tabs, correct = FALSE))$statistic), 2)`$, with 1 degree of freedom. The $p$-value is less than $10^{-4}$, so there is strong evidence of differences between selling format.
