...
- rank absolute values $R_i = \mathrm{rank}(|D_i|)$
...
We use Quade's test, which ranks responses of each participants $1, 2, 3, 4$, followed by a two-way ANOVA with `id` as blocking factor.
