...
- Cohen's $d$'s usual estimator $\widehat{d}_s$ uses sample average of groups and the pooled variance estimator $\widehat{\sigma}$.
- Hedge's $g$ includes a finite sample correction and is less biased (**prefered in practice*)
...
In **R**, use `effectsize::omega_squared(model, partial = TRUE)` or equivalent.
