...
- Cohen's $d$'s usual estimator $\widehat{d}$ uses sample average of groups and the pooled variance estimator $\widehat{\sigma}$.
- Hedge's $g$ includes a finite sample correction and is less biased (*prefered in practice*)

Cohen's classification of effect sizes: small (_d=0.2_), medium (_d=0.5_) or large (_d=0.8_).
...
For the balanced one-way ANOVA, typical estimator is the **coefficient of determination**
