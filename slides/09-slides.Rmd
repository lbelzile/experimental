...
We can also use MANOVA for repeated measures to get above hypothesis of equal variance per group or equal correlation

```{r}
model$Anova # for models fitted via 'afex'
```

Less powerful than repeated measures ANOVA because we have to estimate more parameters...
