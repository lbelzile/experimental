...
model <- aov(likelihood ~ gender * condition,
            data = RS_unb)
library(emmeans)
emm <- emmeans(model, 
               specs = "condition")
...
anova(aov(likelihood ~ 1, data = RS_unb), 
      aov(likelihood ~ condition, 
         data = RS_unb))
# When gender is present      
anova(aov(likelihood ~ gender, data = RS_unb), 
      aov(likelihood ~ gender + condition, 
         data = RS_unb))
