...
.small[Image source: PNGAll.com, CC-BY-NC 4.0]
...
$$\mathscr{H}_0: \underset{\text{weighted sum of subpopulation means}}{c_1 \mu_1 + \cdots + c_K\mu_K} =a$$
--
...
$$\mathscr{H}_0: \frac{n_1}{n} \mu_1 + \cdots + \frac{n_K}{n} \mu_K > a$$
...
Equivalent formulation is obtained by picking $(1,1,-3,0,0)$
