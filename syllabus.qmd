...
If you want to brush up, I can recommend the free ressource [Advanced High School Statistics by Open Intro](https://www.openintro.org/book/ahss/) or @OpenIntro4 --- the material is pretty comprehensive and well structured. I expect many students will have at least this level of knowledge.


# Course materials

I will provide slides, videos and example code in R/SPSS/SAS. In addition to those, there will be assigned readings from textbook and reference papers.

## Textbooks

Course notes for the class can be found [online](https://lbelzile.github.io/math80667a)

I will also assign readings from @Meier:2022
...
5. **Completely randomized designs with two or more factors**
    - Interactions
    - Marginal and conditional contrasts
6. **Blocked designs and analysis of covariance**
...
7. **Replication crisis and effect sizes**
    - Effect sizes
...
9. **Repeated measure designs and random effects**
...
11. **Power and introduction to causal inference**
    - Power calculations
...
12. **Causal inference (continued) and linear mediation model**
    ...
    - Baron--Kenny linear mediation model
    - Sobol's test and introduction to the bootstrap bootstrap.
13. **Additional topics and review**
    - Advanced topics (Bayesian ANOVA, multivariate analysis of variance)
...
The submission modules will stay open for two weeks after the due date for weekly check-in. As much as possible, we will discuss problem sets in class the day after (provided all students have handed in their work). I will not assign penalties, but will gently nudge you to stay on track.
...
assignments <- tibble::tribble(
  ...
  11 * 4 ,   "Problem set (11 x 4 pt)",
  14      , "Paper review (10 pt)",
...
Team work counts toward your final grade only if you obtain  more than 50\% on the individual evaluations. Otherwise, the final grade is calculated on a pro rata basis using only individual evaluations.
