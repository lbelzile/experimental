...
Your final grade will be based on weekly problem sets and feedback, a methodological review of a paper and a final examination. The exam will take place on Friday, December 6th, from 18:30--21:30. 

Problem sets are to be handed in before class so that we can have a timely discussion. For this to happen, I need everyone to hand them in. However, life happens, so the submission module stays open for an additional week if you cannot submit by the deadline.

*New*: If you are unsatisfied with your performance and your grade on a problem set, you may resubmit it **once** after taking my feedback into account in the **two weeks** following grading. Your new grade will replace the old one, with a penalty of 10%. There will be no regrading once solutions or code are shared with the class.
