...
If you are more comfortable with click-and-drop menus, [JAMOVI](https://www.jamovi.org/), [PSPP](https://www.gnu.org/software/pspp/) and [JASP](https://jasp-stats.org/) are suitable open-access options.
...
I will try provide example code in different languages, depending on the software are most commonly adopted.
