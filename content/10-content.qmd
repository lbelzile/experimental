...
- correctly determining crossed and nested effects
- setting up a linear mixed model
- Calculating robust standard errors for clustered data
...
-  {{< fa book >}}  [Chapter 10](https://lbelzile.github.io/math80667a/repeated-measures-and-multivariate-models.html) of the course notes
