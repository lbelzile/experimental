...
<p class="buttons" style="text-align:center;"><span class="btn btn-primary">{{< fa arrow-up-right-from-square >}} View all slides in new window</span> <span class="btn btn-primary">{{< fa file-pdf >}} Download PDF of all slides</span></p>
