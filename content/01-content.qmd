...
slide_details <- tibble::tribble(
  ...
  "", "Review", "review", FALSE,
  "", "Key concepts in experimental design", "key-concepts-experimental", FALSE
)
```
## Content
...
- {{< fa book >}}  Chapter 2 (*Study design*) of [*Introduction to Modern Statistics*](https://openintro-ims.netlify.app/data-design.html)
...
We will discuss the summary of @Mask:2022 ["The Impact of Mask Distribution and Promotion on Mask Uptake and COVID-19 in Bangladesh"](https://www.poverty-action.org/printpdf/47486) in class.
