...
```
If you use macOS, scroll down to the first `.pkg` file in the list of files and download it (in this picture, it's `R-4.0.0.pkg`; as of right now, the current version is `r paste0(R.Version()$major,".", R.Version()$minor, " (", R.Version()$nickname,")")`).
