...
2. Fit a linear mixed model with task timing and age categories, accounting for lab and individual-specific variability. Report the conclusions of the two-way analysis of variance: 
    ...
    b. is the increase between 5 and 7 years the same as from 7 to 10? *Note: this is a contrast*
...
4. Report the lab-specific variability  and comment on regional differences, if any.
5. Compute the correlation of measurements for different individuals in a given lab, following [the example from the course notes](https://lbelzile.github.io/math80667a/mixed.html#exm-verbalization-memorization)
