...
We consider Experiment 3 of @vanStekelenburg:2021; ([download the paper](https://doi.org/10.1177/09567976211007788)). The database can be found in `SSVB21_S3` in the `hecedsm` package.
...
6. If the variance are unequal, fit the model with unequal variances per group (see the [ANCOVA example](example/ancova.html)) --- otherwise proceed as usual.
   ...
   - Does the conclusion of the testchange relative to that reported in the paper?
