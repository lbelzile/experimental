...
Section 3.2 of @Duke.Amir:2022 report the results of an online experiment (Experiment 1) and the impact on sales of sequential vs integrated decision making; the data can be found in the **R** package `hecedsm` under `DA22_E1`; you can also download the [SPSS database](/files/data/SPSS/DA22_E1.sav).
