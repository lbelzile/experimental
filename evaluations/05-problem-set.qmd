...
5. If the interaction is significant, compute simple effects and 95% confidence intervals for the difference in score for `video` conditions. Otherwise, compute marginal effects.
